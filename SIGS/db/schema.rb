...
ActiveRecord::Schema.define(version: 20170616032538) do
  ...
  create_table "all_allocation_dates", force: :cascade do |t|
    t.date     "day"
  ...
  create_table "allocation_extensions", force: :cascade do |t|
  ...
  create_table "categories_school_rooms", id: false, force: :cascade do |t|
    t.integer "category_id",    null: false
  ...
  create_table "courses_school_rooms", id: false, force: :cascade do |t|
  ...
  create_table "degs", force: :cascade do |t|
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "room_solicitations", force: :cascade do |t|
  ...
  create_table "school_rooms", force: :cascade do |t|
    t.string   "name"
    t.integer  "vacancies"
